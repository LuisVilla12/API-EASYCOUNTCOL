...
def vector_caracteristicas():
    ...
    # Cargar imagen
    img_path = rf"Resultados_Final\imgs\{BASE}.jpg"
    ...
    # Guardar
    with open(rf"Resultados_Final\cvs\{BASE}.csv", "w", newline="") as f:
        writer = csv.writer(f)
...
OUT_DIR = r"Resultados_Final\clustering_img"
os.makedirs(OUT_DIR, exist_ok=True)

#RUTA DE LA IMAGEN Y DEL CSV
CSV_PATH = rf"Resultados_Final\cvs\{BASE}.csv"
IMAGE_PATH = rf"Resultados_Final\imgs\{BASE}.jpg"
